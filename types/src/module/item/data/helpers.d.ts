...
export declare function isPhysicalData(
...
export declare function isMagicItemData(
    itemData: ItemSourcePF2e | ItemDataPF2e,
): itemData is MagicItemSource | MagicItemData;
export declare function isLevelItem(
    item: ItemDataPF2e,
): item is PhysicalItemData | FeatData | SpellData;
